...
public class Train {
	...
	public void addRailcarBypassConsole(int railcar_type) {
		...
		if (railcar_type != 0) {
			...
			train[last_wagon] = new Pair(railcar_instance, goods_instance, railcar_type);
			last_wagon += 1;
		}
	}
	...
	public void addRailcar() {
		...
		addRailcarBypassConsole(railcar_type);
	}
	...
	class Pair {
		...
		Pair(Railcar.RailcarParent  railcar, Storage.GoodsParent goods, int wagon_type) {
